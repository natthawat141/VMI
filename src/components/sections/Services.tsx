      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            What <span className="gradient-coral-text">We Do</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {services.map((service, index) => (
            <div
              key={service.id}
              className={`group relative bg-[#1a1a1a] rounded-2xl p-8 border border-white/5 hover:border-[#FF6A6A]/30 transition-all duration-500 cursor-pointer overflow-hidden ${
                isVisible
